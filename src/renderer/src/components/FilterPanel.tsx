...
export function FilterPanel() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-t-3xl border-t border-slate-800/60 bg-[#0f172a]/95 shadow-2xl backdrop-blur-xl pb-safe lg:rounded-3xl lg:border lg:pb-0 lg:animate-in lg:fade-in lg:slide-in-from-right-4 lg:duration-300">
      {/* Mobile drag handle */}
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 lg:p-5 custom-scrollbar">
